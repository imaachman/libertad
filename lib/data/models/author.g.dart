...
extension AuthorQueryFilter on QueryBuilder<Author, Author, QFilterCondition> {
  ...
  QueryBuilder<Author, Author, QAfterFilterCondition> booksElementEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Author, Author, QAfterFilterCondition> booksElementGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Author, Author, QAfterFilterCondition> booksElementLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Author, Author, QAfterFilterCondition> booksElementBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Author, Author, QAfterFilterCondition> booksElementStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Author, Author, QAfterFilterCondition> booksElementEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Author, Author, QAfterFilterCondition> booksElementContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Author, Author, QAfterFilterCondition> booksElementMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Author, Author, QAfterFilterCondition> booksElementIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'books',
        value: '',
  ...
  QueryBuilder<Author, Author, QAfterFilterCondition> booksElementIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'books',
        value: '',
...
extension AuthorQueryWhereDistinct on QueryBuilder<Author, Author, QDistinct> {
  ...
  QueryBuilder<Author, Author, QDistinct> distinctByBooks() {
    return QueryBuilder.apply(this, (query) {
...
extension AuthorQueryProperty on QueryBuilder<Author, Author, QQueryProperty> {
  ...
  QueryBuilder<Author, List<String>, QQueryOperations> booksProperty() {
    return QueryBuilder.apply(this, (query) {
